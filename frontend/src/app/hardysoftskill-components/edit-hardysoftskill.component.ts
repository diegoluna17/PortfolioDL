...
export class EditHardysoftskillComponent {
  hyss: Hardysoftskill
  
  constructor(private sHyss: SHardysoftskillService,  private activateRouter: ActivatedRoute, private router: Router, public imageService: ImageService) { }
